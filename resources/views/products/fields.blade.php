...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        <div class="col-3 text-right control-label" style="font-weight: 700;">
            Visibility
        </div>
        <div class="col-9">
            <select class="form-control" name="enable" id="visibility">
                @if(isset($product))
                    @if($product->enable == 0)
                        <option value="1" onclick="functionChecked(1);" >Enable</option>
                        <option value="0"  onclick="functionChecked(0);" selected>Disable</option>
                    @else
                        <option value="1"  onclick="functionChecked(1);" selected>Enable</option>
                        <option value="0"  onclick="functionChecked(0);" >Disable</option>
                    @endif
                @else
                    <option value="1"  onclick="functionChecked(1);" selected>Enable</option>
                    <option value="0"  onclick="functionChecked(0);" >Disable</option>
