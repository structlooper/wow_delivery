...
<script type="text/javascript">
    ...
    var dropzoneFields = [];
     ...
     $('#visibility').change(function(){
         let value = $(this).val()
         if(value == 0){
             $('#dis_time').removeAttr('disabled')
             $('#dis_time').html('<option value="4" >4 hr</option><option value="8" >8 hr</option><option value="24" >1 day</option>');
         }else{
             $('#dis_time').attr('disabled' ,true)
             $('#dis_time').html('<option value="null">--select time--')
