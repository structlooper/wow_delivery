...
<div class="form-group row ">
  ...
  <!-- Usage Field -->
<div class="form-group row ">
  {!! Form::label('Usage', 'Usage', ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
   <select class="form-control" name="useage">
     @if(isset($coupon))
       @if($coupon->useage == "MULTI")
         <option selected value="MULTI">Multiple times</option>
         <option value="SINGLE">Single time</option>
       @else
         <option value="MULTI">Multiple times</option>
         <option selected value="SINGLE">Single time</option>
       @endif
     @else
       <option value="MULTI">Multiple times</option>
       <option value="SINGLE">Single time</option>
